...
"Slow /1000" is the number of frames under 30 FPS per 1000 measured frames.
The minimum is one frame, and a background hitch can set it in any mode. Read
the rate before the minimum (PHI-176).
